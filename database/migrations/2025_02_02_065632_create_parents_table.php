...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('parents', function (Blueprint $table) {
            ...
            $table->string('wali_full_name');
            $table->unsignedBigInteger('wali_m_life_status_id');
            $table->string('wali_nik');
            $table->string('wali_birth_place');
            $table->date('wali_birth_date');
            $table->unsignedBigInteger('wali_m_last_education_id');
            $table->unsignedBigInteger('wali_m_job_id');
            $table->unsignedBigInteger('wali_m_average_income_per_month_id');
